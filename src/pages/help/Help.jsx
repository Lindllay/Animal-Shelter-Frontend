      ...
      <section className={styles.section}>
        ...
        <article className={styles.article}>
          <div>
            ...
            <p className={styles.paragraph}>
              ...
              zwierząt na spacery, pomoc w ich socjalizacji, pielęgnacji,
              treningu i wychowaniu, aktywne uczestnictwo w zbiórkach karm dla
              schroniska, promowanie idei adopcji zwierząt, szukanie nowych
              domów dla bezdomnych psów i kotów. Wolontariusze przechodzą
              specjalne szkolenia, które zaznajamiają ich z zasadami
              funkcjonowania placówek i przygotowują do wypełniania czekających
              na nich zadań. Wolontariusze współpracują ze schroniskiem na
        ...
        <article className={styles.article}>
          <div>
            ...
            <p className={styles.paragraph}>
              Spacery z psami, w przeciwieństwie do wolontariatu, są formą
              pomocy jednorazowej. Nie wymagają znacznego nakładu, czasu, dużego
              zaangażowania ani regularnych wizyt. Mogą być natomiast wspaniałym
              początkiem pomocy w schronisku i zachętą do zaangażowania się w
              inne akcje. Aby wziąć udział w spacerze, wystarczy wcześniej
              zgłosić chęć uczestnictwa telefonicznie lub za pośrednictwem
              internetu.
            </p>
          </div>
        ...
        <article className={styles.article}>
          <div>
            ...
            <p className={styles.paragraph}>
              ...
              czasu znalezienia nowych opiekunów. Osoby opiekujące się
              zwierzętami pozostają w ścisłym kontakcie ze schroniskiem, które
              udziela im niezbędnej pomocy i poszukuje domu dla podopiecznych.
            </p>
          </div>
